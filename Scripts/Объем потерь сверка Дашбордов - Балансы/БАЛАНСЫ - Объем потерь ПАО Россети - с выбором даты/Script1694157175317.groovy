...
WebUI.click(findTestObject('Объем потерь сверка/убрать Год'))
...
WebUI.scrollToElement(findTestObject('Объем потерь сверка/2022 год'), 30)

WebUI.scrollToElement(findTestObject('Объем потерь (Данные в виджетах)/скролл'), 30)

WebUI.click(findTestObject('Объем потерь сверка/2022 год'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Объем потерь сверка/выбрать 1 квартал 2022'))

WebUI.click(findTestObject('Объем потерь сверка/выбрать 2 квартал 2022'))
...
WebUI.click(findTestObject('Объем потерь сверка - Балансы/фильтр Дата'))

WebUI.scrollToElement(findTestObject('Объем потерь сверка - Балансы/2023 год'), 30)

WebUI.scrollToElement(findTestObject('Объем потерь сверка - Балансы/a_scroll'), 30)

WebUI.click(findTestObject('Объем потерь сверка - Балансы/2023 год'))

WebUI.scrollToElement(findTestObject('Объем потерь сверка - Балансы/4 квартал 2023'), 30)

WebUI.click(findTestObject('Отпуск из сети (БАЛАНСЫ)/выбрать 1 квартал 2023'))

WebUI.click(findTestObject('Объем потерь сверка - Балансы/выбрать 2 квартал 2023'))

WebUI.click(findTestObject('Объем потерь сверка - Балансы/раскрыть 3 квартал 23'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.click(findTestObject('Объем потерь сверка - Балансы/Июль'), FailureHandling.CONTINUE_ON_FAILURE)

WebUI.scrollToElement(findTestObject('Объем потерь сверка - Балансы/выбрать год 2022'), 30)

WebUI.scrollToElement(findTestObject('Объем потерь сверка - Балансы/a_scroll'), 30)

WebUI.click(findTestObject('Объем потерь сверка - Балансы/2022 год'))

WebUI.click(findTestObject('Объем потерь сверка - Балансы/выбрать 1 квартал 2022'))

WebUI.click(findTestObject('Объем потерь сверка - Балансы/выбрать 2 квартал 2022'))

WebUI.click(findTestObject('Объем потерь сверка - Балансы/применить в фильтре Дата'))
