...
static def Testing1() {
    ...
    def selectKpo = SelektKpoAndFirstStep()

    WebUI.click(findTestObject('КПО/раскрыть АО Тываэнерго'))

    WebUI.click(findTestObject('КПО/филиал АО Тываэнерго'))
    ...
    WebUI.click(findTestObject('КПО/раскрыть АО Чеченэнерго'))

    WebUI.click(findTestObject('КПО/выбрать Чеченэнерго'))
    ...
    WebUI.click(findTestObject('КПО/Колэнерго'))
...
static def SelectDate() {
    ...
    WebUI.click(findTestObject('КПО/раскрыть 3 квартал 23'))
...
static def SelektKpoAndFirstStep() {
    def filter1 = VariantFilter1()

    def filter2 = VariantFilter2()
